...
""" This class serves as the database storage for AirBnB """
...
class DBStorage:
    ...
    def all(self, cls=None):
        ...
        """ Query for objects based on the specified class
        Arguments:
            cls: Class to be used for the query
        """
        d = {}
    ...
    def close(self):
        ...
        """ Remove the current session and roll back all unsaved transactions """
        if self.__session:
